...
<body>
  <main> 
    ...
    <section class="TopDealsBanner">
      ...
      <div class="Cta">
        <img class="BigCTAimg" src="{{asset('images/BigCTA.svg')}}" alt="Laptop Image" />
      ...
      <div class="NewDeals">
        ...
        <img class="NewDealsimg" src="{{asset('images/NewDeals.svg')}}" alt="Promotional Image" />
    ...
    <section class="Page1">
      <header class="categories-header">
        <div class="view-all-wrapper">
          ...
          <a href="{{url('/products')}}" class="view-all-link" tabindex="0">
            <span>View All</span>
      ...
      <nav class="categories-grid">
        <ul class="items-container">
          ...
          <a href="{{url('Tablets')}}">
            <div class="category-icon-wrapper">
              <img src="{{asset('images/Lenovo.svg')}}" alt="Headphones category" class="category-icon" />
            </div>
          </a>
