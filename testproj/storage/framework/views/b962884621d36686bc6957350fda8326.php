...
<body>
    <header>
        <header class="header">
            ...
            <div class="icons">
                <a href="profile.html" class="user-icon" title="Sign in"><img src="<?php echo e(asset('images/user.svg')); ?>" height="30"></a>
                <a href="wishlist.html" class="wishlist-icon" title="Wishlist"><img src="<?php echo e(asset('images/heart.svg')); ?>" height="30"></a>
                <a href="cart.html" class="cart-icon" title="Basket"><img src="<?php echo e(asset('images/basket.svg')); ?>" height="30"></a>
            </div>
        </header>
...
</html><?php /**PATH C:\Users\dilax\Team-21\Team-21\resources\views/checkout.blade.php ENDPATH**/ ?>